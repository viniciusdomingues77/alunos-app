...
export default function AgendamentoTurma () {
  ...
  const handleClickConfirmar = () => {
    ...
    var frasediasdasemana = DiasdaSemanaFrase(stateDiasdaSemanana)
    var hora = HoraFormatada(selectedHour)
    var dt = ConvertDataJSParaDataExtenso(selectedDate)
    if (MarcacaoSemestral === true) {
      var msg =
        'A turma será agendada ' +
        ' a partir de ' +
        dt +
        ' para ' +
        frasediasdasemana +
